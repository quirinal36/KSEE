...
import www.ksee.kr.security.CustomAuthenticationFailureHandler;
import www.ksee.kr.security.CustomAuthenticationSuccessHandler;
import www.ksee.kr.security.CustomLogoutSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	private static final String[] IGNORED_RESOURCE_LIST = new String[] {"/resources/**", "/robots.txt", "/sitemap.xml","/.well-known/**"};
	@Autowired
