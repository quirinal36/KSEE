				...
				<form action="<c:url value="/admin/${where }/write"/>" method="POST">
					...
					<div class="bt_wrap mb-60">
						<c:if test="${empty symposium }">
							<a href="#:;" class="bt1 on" onclick="javascript:registSymposium();">등록</a>
						...
						<c:if test="${not empty symposium }">
							...
							<a href="#:;" class="bt1 on" onclick="javascript:updateSymposium();">수정</a>
							<a href="#:;" class="bt1" onclick="javascript:deleteSymposium();">삭제</a>
						</c:if>
					</div>
				</form>
			</div>
